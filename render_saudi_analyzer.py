    ...
    def generate_realistic_financial_data(self, ticker):
        ...
        try:
            ...
            financial_data = {
                ...
                'data_source': 'Intelligent Mock Data (Render Cloud)'
            }
...
def main():
    ...
    with tab1:
        ...
        if st.button("🚀 Start Analysis", type="primary"):
            ...
            status_text.text("💰 Generating realistic financial data...")
            progress_bar.progress(0.2)
            
            financial_data = analyzer.generate_realistic_financial_data(ticker)
            if financial_data:
                results['financial_data'] = financial_data
                st.success("✅ Financial data generated successfully!")
            else:
                st.error("❌ Failed to generate financial data")
                return
